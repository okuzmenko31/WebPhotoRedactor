<template>
    <div class="success_container">
        ...
        <div v-show="validURL === true && success === true" id="success_modal" class="white">
            ...
            <p style="color: yellow" class="align_center_text no-margin">You'll be automaticly redirected</p>
        </div>
    ...
    export default {
        ...
        mounted() {
            ...
            if (this.$route.query.token !== undefined) {
                ...
                this.validURL = true
                axios.post(`${import.meta.env.VITE_BACKEND_DOMAIN}/api/v1/payments/paypal/foreign/cancel_order/${this.queryToken}/`, {})
                .then(res => {
                    this.success = true
