<template>
    <div class="wrapper-cont-cont">
        <p class="brand_text no-margin">Use cases</p>
        <p class="fs--50 header_text fw--900 align_center_text no-top">FlexFi Upscale use cases</p>
        <div class="wrapper">
            <div class="box1 box">
