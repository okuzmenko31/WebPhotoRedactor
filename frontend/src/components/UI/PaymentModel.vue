<template>
    <div @click="toggleActive" :id="bxId" :class="{ active: isActive }" class="ContentBx-pay white">
        <div class="Label-pay" :id="localId" :class="{ active: isActive }">
            ...
            <svg v-else version="1.1" xmlns="http://www.w3.org/2000/svg" width="30px" height="30px"  xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            ...
            <g id="XMLID_2206_">
                ...
                <path id="XMLID_2209_" style="fill:#5A8BB0;" d="M194.377,150h41.858c-5.35-8.09-4.462-19.089,2.663-26.214
                    ...
                    <rect id="XMLID_2210_" x="182.184" y="-10.691" transform="matrix(0.7071 0.7071 -0.7071 0.7071 96.6202 -121.2638)" style="fill:#5A8BB0;" width="25.01" height="133.379"/>
        ...
        <div class="Content-pay small_text" @click.stop :class="{ active: isActive }">
            ...
            <div v-if="method == 'paypal'" @click="func" class="paypal__btn"><svg fill-rule="evenodd" clip-rule="evenodd" style="color: #000" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-wallet" viewBox="0 0 16 16"> <path d="M3.01493 0.378732C3.07058 0.156149 3.27057 0 3.5 0H8.16104C10.5583 0 12.3523 1.95748 12.3647 4.17206C14.2927 4.79825 15.3862 7.02313 14.4695 9.00923C13.7687 10.5276 12.249 11.5 10.5767 11.5H9.37716L8.48077 14.6374C8.41944 14.852 8.22325 15 8 15H4C3.84604 15 3.70066 14.9291 3.6059 14.8077C3.51115 14.6863 3.47759 14.5281 3.51493 14.3787L3.85962 13H0.500005C0.346037 13 0.200655 12.9291 0.105902 12.8077C0.0111482 12.6863 -0.0224094 12.5281 0.0149333 12.3787L3.01493 0.378732ZM8.16104 1C9.92319 1 11.2575 2.38818 11.3578 4.00117C11.3268 4.00039 11.2957 4 11.2644 4H6.5C6.27057 4 6.07058 4.15615 6.01493 4.37873L4.10962 12H1.14039L3.89039 1H8.16104ZM7.29496 9H5.89039L4.64039 14H7.62285L8.51924 10.8626C8.58057 10.648 8.77676 10.5 9 10.5H10.5767C11.8589 10.5 13.0242 9.75443 13.5615 8.59018C14.1878 7.23324 13.5049 5.72079 12.2427 5.19362C12.2031 5.35415 12.1535 5.51468 12.0935 5.67459C11.3434 7.67485 9.43124 9 7.29496 9Z" fill="#000"></path></svg></div>
